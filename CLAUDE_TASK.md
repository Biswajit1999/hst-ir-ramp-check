# Claude Code Task — HST WFC3/IR Up-the-Ramp Linearity Audit
...
5. Implement reusable scientific modules under `src/hst_wfc3ir_ramp_linearity_audit/`; notebooks must only orchestrate imported functions.
